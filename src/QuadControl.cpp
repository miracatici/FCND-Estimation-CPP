...
V3F QuadControl::BodyRateControl(V3F pqrCmd, V3F pqr)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
  V3F error, omega_out, inertia(Ixx,Iyy,Izz);

  error = pqrCmd - pqr;
  omega_out = error * kpPQR;
  momentCmd = inertia * omega_out;
  /////////////////////////////// END STUDENT CODE ////////////////////////////
...
float QuadControl::AltitudeControl(float posZCmd, float velZCmd, float posZ, float velZ, Quaternion<float> attitude, float accelZCmd, float dt)
{
  ...
  float omega_out = kpVelZ * (velo_z_command - velZ) + KiPosZ * integratedAltitudeError + accelZCmd;

  thrust = -(omega_out - 9.81f) * mass / R(2,2);
...
V3F QuadControl::LateralPositionControl(V3F posCmd, V3F velCmd, V3F pos, V3F vel, V3F accelCmdFF)
{
  ...
  if(velo_z_command.mag() > maxSpeedXY)
  {
      velo_z_command *= maxSpeedXY / velo_z_command.mag();
  }
