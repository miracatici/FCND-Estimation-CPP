...
void QuadEstimatorEKF::UpdateFromIMU(V3F accel, V3F gyro)
{
  ...
  rollEst = attitudeTau / (attitudeTau + dtIMU) * (rollPrediction)+dtIMU / (attitudeTau + dtIMU) * accelRoll;
  pitchEst = attitudeTau / (attitudeTau + dtIMU) * (pitchPrediction)+dtIMU / (attitudeTau + dtIMU) * accelPitch;
